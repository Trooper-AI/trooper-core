...
- ACP is available for heavier repo, terminal, and multi-file debugging loops, but do not escalate to ACP for ordinary chat replies.${projectScope}${deviceScope}`;
    default:
      return deviceScope ? `[EXECUTION TARGET]\n${deviceScope.trimStart()}` : '';
  }
}
