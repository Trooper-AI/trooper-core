...
- ACP is available for heavier repo, terminal, and multi-file debugging loops, but do not escalate to ACP for ordinary chat replies.`;
    default:
      return '';
  }
}
...
- Mention the concrete files, rows, or artifacts you changed.`;
  ...
  const laneBlock = buildExecutionLanePromptBlock({ executionLane, browserTask });
  if (laneBlock) {
    prompt += `\n\n${laneBlock}`;
  }
