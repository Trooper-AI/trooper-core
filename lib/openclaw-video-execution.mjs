...
export function inferVideoExecutionContract({ task = '', systemPrompt = '', context = {} } = {}) {
  ...
  const videoVocabulary = /\b(?:videos?|clips?|footage|mp4|mov\b|webm|reels?|tiktoks?|youtube shorts?|podcast|talking[- ]head|b[- ]roll|timeline|long[- ]to[- ]shorts?)\b/.test(combined);
