...
const CLAUDE_PACK = {
  ...
  rules: [
    {
      // Claude Code permission prompts read "Do you want to …?" with a yes/allow
      // choice. Negative evidence keeps quota/auth text from ever reading as an
      // approval prompt.
      ...
      any: [{ contains: ['yes'] }, { contains: ['allow'] }, { contains: ['proceed'] }],
  ...
  rules: [
    {
      ...
      region: 'text_tail(30)',
      any: [
        { regex: ['\\ballow (this )?(command|tool|action)\\b'] },
