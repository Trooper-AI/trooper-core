...
export const MANAGED_ACP_CLI_CATALOG = Object.freeze({
  ...
  opencode: Object.freeze({
    ...
    authHint: 'OpenCode has no generic sign-in. Choose a provider, then configure that provider’s supported credential on the gateway. Trooper will not choose a provider or submit credentials for you.',
  }),
});
