...
export function registerApiRoutes(app, { agentRegistry, gateway, bridgeWS, getCompanyDocs, setCompanyDocs }) {
  ...
  // Accepts either X-API-Key (Obsidian plugin) or Bearer token (CrabsHQ frontend/proxy).
  ...
  function requireApiKey(req, res, next) {
    ...
    // Check Bearer token (CrabsHQ frontend proxy) — trust if present (already verified by CrabsHQ server)
